...
const testimonials = [
  {
    quote:
      "VANESSA’S WORK IS TRULY REMARKABLE. SHE CAPTURED THE MOST CANDID AND EMOTIONAL MOMENTS DURING OUR WEDDING, MAKING US RELIVE THE MAGIC EVERY TIME WE LOOK AT THE PHOTOS. HER TALENT, PROFESSIONALISM, AND PASSION SHINE THROUGH IN EVERY FRAME!",
    name: 'MICHAEL & ANNA K',
    role: 'NEWLYWEDS',
    background:
  ...
  {
    quote:
      "ABSOLUTELY STUNNING PHOTOS! VANESSA HAS AN EYE FOR DETAIL AND A STYLE THAT FEELS TIMELESS. OUR WEDDING ALBUM FEELS LIKE ART.",
    name: 'EMILY & DANIEL M',
    role: 'COUPLE',
    background:
