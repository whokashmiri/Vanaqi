        ...
        <div className="card">
          ...
          <div className="bottom">
            ...
            <div className="view-more">
              <button className="view-more-button">SOCIAL</button>
...
const StyledWrapper = styled.div`
  ...
  .card {
    height: 100%;
    border-radius: 50px;
    background: linear-gradient(135deg, rgb(0, 150, 214) 0%, rgb(8, 226, 96) 100%);
  ...
  .glass {
    ...
    background: linear-gradient(0deg, rgba(255, 0, 255, 0.349) 0%, rgba(92, 120, 150, 0.815) 100%);
